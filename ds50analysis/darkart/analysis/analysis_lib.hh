...
namespace ds50analysis {
  ...
  void top_bot_s1_s2(EventData* event, Int_t const s1_pulse_id, Int_t const s2_pulse_id,
                     Double_t & top_s1, Double_t & bot_s1,
                     Double_t & top_s2, Double_t & bot_s2);
...
void ds50analysis::top_bot_s1_s2(EventData* event, Int_t const s1_pulse_id, Int_t const s2_pulse_id,
                                 Double_t & top_s1, Double_t & bot_s1,
                                 Double_t & top_s2, Double_t & bot_s2)
{
  top_s1 = 0; bot_s1 = 0;
